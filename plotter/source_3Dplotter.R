...
template = load.nifti(paste0(PATH_DATA, 'MNI152_T1_2mm_brain.nii.gz'))
dtemp = dim(template)

target.val = c(9032, 9140) #cerebellum_4_5_R and Vermis_7

aal = load.nifti(paste0(PATH_DATA, 'AAL_MNI_2mm.nii'))
...
contour3d(aal1, x = 1:dtemp[1], y = 1:dtemp[2], z = 1:dtemp[3], add = T,
