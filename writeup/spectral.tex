...
\begin{definition}
[Adjacency matrix] Let $G$ be a graph with weights $w$.
...
\begin{definition}
[Degree matrix] Let $G$ be a graph with weights $w$, and $A$ be
...
A result of spectral bipartitioning on a resting state fMRI scan
...
\begin{definition}
[Cut weight] For a partition $\mathcal{P}_k = (V_1, ..., V_k)$, the cut
...
\begin{definition}
[Ratio-cut cost] For a given partition
